...
def run_epoch(
    ...
    totals = {
        ...
        "p2_loss": 0.0,
        "dynamics_loss": 0.0,
        "dynamics_latent_loss": 0.0,
        "dynamics_state_loss": 0.0,
    }
...
def main():
    ...
    parser.add_argument("--output_dir", default="outputs/piwm_pair_baseline")
    ...
    parser.add_argument("--pred_recon_weight", type=float, default=1.0)
